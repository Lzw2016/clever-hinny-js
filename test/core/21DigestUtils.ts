...
const t01 = function () {
    ...
    log.info("sha1                      --------------->{}", digestUtils.sha1(Java.type("org.apache.commons.io.FileUtils").openInputStream(new File("C:\\Users\\ymx\\Desktop\\叶茂祥-周报(8.17-8.21).xlsx"))));
    ...
    log.info("md5                       --------------->{}", digestUtils.md5(Java.type("org.apache.commons.io.FileUtils").openInputStream(new File("C:\\Users\\ymx\\Desktop\\叶茂祥-周报(8.17-8.21).xlsx"))));
}
