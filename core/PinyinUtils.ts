export enum HanyuPinyinCaseType {
    /** 大写 */
    UPPERCASE = "UPPERCASE",
    /** 小写 */
    LOWERCASE = "LOWERCASE",
...
export enum HanyuPinyinToneType {
    /** 此选项表示以声调数字输出汉语拼音 */
...
export enum HanyuPinyinVCharType {
    /** 该选项表示'ü'的输出是'u:' */
...
export interface HanyuPinyinOutputFormat {
...
const pinyinUtils: PinyinUtils = Java.type('org.clever.hinny.graal.core.PinyinUtils').Instance;
