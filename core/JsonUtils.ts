export interface JsonUtils {
     ...
     * @return 序列化后的Json字符串
     */
    toJson(object: object): JString

    /**
     * 输出JSON格式数据.
     */
    toJsonP(functionName: JString, object: object): JString
     ...
     * @return 操作成功返回true
     */
    update(json: JString, object: object): JBoolean
...
const jsonUtils: JsonUtils = Java.type('org.clever.hinny.core.JsonUtils').Instance;
